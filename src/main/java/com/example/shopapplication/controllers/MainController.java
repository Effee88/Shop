...
import com.example.shopapplication.models.Cart;
...
import com.example.shopapplication.repositories.CartRepository;
...
public class MainController {
    ...
    public String index(Model model){
        // Получаем объект аутентификации -> с помощью SpringContextHolder обращаемся к контексту
        // и на нем вызываем метод аутентификации. Из сессии текущего пользователя получаем объект,
